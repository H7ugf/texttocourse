...
const RefundEdit = () => {
    ...
    const [terms, setTerms] = useState(sessionStorage.getItem('refund'));
    ...
    async function saveTerms() {
        ...
        const response = await axios.post(postURL, { data: terms, type: 'refund' });
        if (response.data.success) {
            sessionStorage.setItem('refund', terms);
    ...
    return (
        <div>
            <div className='flex flex-row'>
                <h1 className='text-black font-black text-3xl p-4'>Refund</h1>
            ...
            <div className="textarea-container">
                <textarea
                    placeholder='Write your refund here in HTML format'
