...
const CancellationEdit = () => {
    ...
    const [terms, setTerms] = useState(sessionStorage.getItem('cancel'));
    ...
    return (
        <div>
            <div className='flex flex-row'>
                <h1 className='text-black font-black text-3xl p-4'>Cancellation</h1>
            ...
            <div className="textarea-container">
                <textarea
                    placeholder='Write your cancellation here in HTML format'
...
export default CancellationEdit;